...
function MainApp() {
  ...
  return (
    <>
      <div className="container-fluid bg-light p-3 m-0 vh-100 d-flex align-items-center justify-content-center">
        <div
          className="shadow-lg p-3 bg-white rounded mx-auto"
          style={{ width: '90%', maxWidth: '500px', height: 'auto' }}
        >
          <div className="mb-2 mt-1">
            <label htmlFor="Name" className="mb-1 fs-6">
              Name:
            </label>
            <input
              type="text"
          ...
          <div className="mb-2 mt-1">
            <label htmlFor="Email" className="mb-1 fs-6">
              Email:
            </label>
            <input
              type="email"
          ...
          <div className="form-group mt-1">
            ...
            <label className="form-label mb-0">
              <input
                ...
                name="languages"
                value="html"
                checked={FormValues.languages.includes('html')}
                onChange={handlechange}
              />
              HTML
            </label>
            ...
            <label className="form-label mb-0">
              <input
                ...
                name="languages"
                value="css"
                checked={FormValues.languages.includes('css')}
                onChange={handlechange}
              />
              CSS
            </label>
            ...
            <label className="form-label mb-2">
              <input
                ...
                name="languages"
                value="Javascript"
                checked={FormValues.languages.includes('Javascript')}
                onChange={handlechange}
              />
              Javascript
            </label>
